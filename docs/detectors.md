...
driftcheck ships **58 detector modules** covering **73 independent detectors**. Each checks for a specific kind of version drift between toolchain files and documentation.

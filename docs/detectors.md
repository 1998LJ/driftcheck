...
driftcheck ships **64 detector modules** covering **68 registered detectors**. Each checks for a specific kind of version drift between toolchain files and documentation.

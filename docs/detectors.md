...
driftcheck ships **60 detector modules** covering **64 registered detectors**. Each checks for a specific kind of version drift between toolchain files and documentation.

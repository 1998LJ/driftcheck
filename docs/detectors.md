...
driftcheck ships **61 detector modules** covering **63 registered detectors**. Each checks for a specific kind of version drift between toolchain files and documentation.
